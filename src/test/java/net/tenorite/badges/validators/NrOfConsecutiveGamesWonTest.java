 ...
 */
public class NrOfConsecutiveGamesWonTest extends AbstractValidatorTestCase {

    private NrOfConsecutiveGamesWon validator = new NrOfConsecutiveGamesWon(BADGE, 5);
