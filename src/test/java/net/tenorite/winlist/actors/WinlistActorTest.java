...
public class WinlistActorTest extends AbstractActorTestCase {
    ...
    public void testWinlistIsPublishedWhenPlayerJoinedChannel() {
        ...
        winlist.tell(ChannelJoined.of(Tempo.FAST, GameMode.CLASSIC, "channel", "john"), noSender());

        subscriber.expectMsgAllOf(WinlistUpdated.of(Tempo.FAST, GameMode.CLASSIC, emptyList()));
    }
